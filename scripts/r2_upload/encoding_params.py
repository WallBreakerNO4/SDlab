...
AVIF uses Pillow save args (quality/speed/subsampling/max_threads), not CRF.
Chosen values keep "display higher quality than thumb":
- display -> quality=72, speed=8, subsampling="4:2:0", max_threads=2
- thumb -> quality=58, speed=9, subsampling="4:2:0", max_threads=2
"""

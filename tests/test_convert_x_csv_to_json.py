...
from scripts.other.convert_x_csv_to_json import convert_csv_to_yaml


def test_convert_x_csv_to_yaml_maps_type_and_descriptions(tmp_path: Path) -> None:
    ...
    count = convert_csv_to_yaml(csv_path, out_path, schema="", item_type="sfw")
...
def test_convert_x_csv_to_yaml_fallbacks_when_columns_empty_or_missing(
    tmp_path: Path,
) -> None:
    csv_path = tmp_path / "x.csv"
    out_path = tmp_path / "x.yaml"
